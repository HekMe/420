...
<html lang="en">
  ...
  <body>
    ...
    <div id="1">
      ...
      <div id="btn">
        <button id="join_joint" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" onClick='location.href+="?joinJoint=1"'>
            Joint Join 🍀
        </button>
        <button id="cast" is='google-cast-button'></button>
      </div>
